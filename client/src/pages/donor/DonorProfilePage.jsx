...
export default function DonorProfilePage() {
  ...
  const c = BLOOD_GROUP_COLORS[donor.bloodGroup] || {};
      ...
      <div className="card animate-fadeIn">
        <div className="card-body">
          <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
            <div className="avatar avatar-xl" style={{ background: c.bg || "var(--purple-light)", color: c.text || "var(--purple)" }}>{donor.name?.charAt(0)?.toUpperCase()}</div>
            <div style={{ flex: 1 }}>
          ...
          <div className="grid grid-2">
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: 14 }}>
                ...
                <span style={{ display: "flex", alignItems: "center", gap: 8, color: donor.isAvailable ? "#059669" : "var(--text-muted)" }}>{donor.isAvailable ? "Available" : "Unavailable"}</span>
              </div>
            </div>
          </div>
