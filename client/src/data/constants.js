/**
 * constants.js — All Static Data for the App
 * 
 * This file contains all the fixed data that the app uses:
 * - Blood group names and their colors (for both light and dark mode)
 * - List of 15 Bangladeshi districts and their sub-areas
 * - Blood request urgency levels and statuses
 * - Landing page statistics, testimonials, and FAQs
 * 
 * These are imported by various pages. Example:
 *   import { BLOOD_GROUPS, DISTRICTS } from "../data/constants";
 */

/** All 8 blood types available in the system */
export const BLOOD_GROUPS = ["A+","A-","B+","B-","AB+","AB-","O+","O-"];

/**
 * Color schemes for each blood group badge.
 * Each has two sets: light mode colors and dark mode colors.
 * Used to color-code blood group badges throughout the app.
 */
...
/**
 * Sub-areas within each district.
 * Used in dropdown menus — when you select a district, the area dropdown populates with its areas.
 * Example: Selecting "Dhaka" shows "Gulshan", "Banani", "Dhanmondi", etc.
 */
export const AREAS = {
...
/** Urgency levels for blood requests — each has a label and CSS badge class */
...
/** Status values for blood requests — with labels and badge colors */
export const STATUS = [
...
/** Statistics shown on the landing page */
export const STATS = [
...
/** Testimonials from real users — displayed on the landing page */
...
/** Frequently asked questions — shown in an accordion on the landing page */
export const FAQS = [
